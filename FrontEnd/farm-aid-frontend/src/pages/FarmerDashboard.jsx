  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] flex font-sans text-gray-800">
      ...
      <main className="flex-1 ml-[280px] flex flex-col min-h-screen">
        ...
        {/* Dashboard Content */}
        <div className="p-10 pt-4 flex-1 overflow-y-auto w-full max-w-[1400px] mx-auto relative z-10">
          
          {/* Welcome Banner */}
          <div className="rounded-2xl overflow-hidden mb-8 relative shadow-lg h-48 md:h-64 flex items-end"
               style={{
          ...
          >
            ...
            <div className="relative z-10 p-8 w-full">
              <h2 className="text-3xl font-extrabold text-white mb-2 tracking-tight">Welcome to your Farm Portal</h2>
              <p className="text-gray-200 font-medium max-w-xl">Monitor your herd's health, consult with experts, and keep your records up-to-date with our offline-first tools.</p>
            </div>
          </div>
